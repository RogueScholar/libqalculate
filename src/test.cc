  ...
  if (mstruct2.isNumber() && mstruct3.isNumber()) {
    if (!mstruct2.equals(mstruct3, true, true)) {
      ...
      if (!b_equal) {
        ...
        successes++;
        if (!mstruct2.isNumber() || !mstruct2.number().isReal())
          imaginary++;
      }
    } else {
      successes++;
  ...
  if ((num_ratio_den ? (r != 1) : (r == 1)) ||
    ...
    if (allow_unit &&
      ...
      if (!allow_unknown) {
        ...
        r = (rand() % ((allow_function ? 33 + allow_unknown : 5) - au2)) + 4 -
            allow_unknown;
...
int main(int argc, char *argv[]) {
  ...
  for (size_t i = 0; i <= 50000; i++) {
    ...
    // if(i % 100 == 0) cout << endl << rt1 << ":" << rt2 << ":" << rt3 << ":"
    // << rt4 << ":" << rt5 << ":" << rt6 << ":" << rt7 << ":" << rt8 << ":" <<
    // rt9 << endl << endl;
  }
  cout << endl
