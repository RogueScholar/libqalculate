...
static const bool has_leap_second[] =
    {
        ...
        false, true,  false, true,  false, true,  false, false, // 1980
        true,  false, true,  false, true,  false, false, false,
        true,  false, false, false, false, true,  false, false,
        false, true,  false, true, // 1990
...
#define CHINESE_EPOCH -963099L // date_to_fixed(-2636, 2, 15,
                               // CALENDAR_GREGORIAN)
...
Number lunar_phase_at_or_after(Number phase, Number tee) {
  ...
  while (true) {
    ...
    if (aphase > bphase) {
      if ((newphase > phase && newphase < aphase) ||
          (newphase < phase && newphase < aphase))
        b = test;
      else
        a = test;
    } else {
