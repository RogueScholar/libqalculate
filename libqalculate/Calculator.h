 ...
 *should first call Calculalor::unlocalizeExpression() on the expression.
 *
 ...
 *be used, whithout the possiblity to specify a time limit.
 *
 * Central to the flexiblity of libqalculate is the many options passed to
...
protected:
  ...
  string NAME_NUMBER_PRE_S, NAME_NUMBER_PRE_STR, DOT_STR, DOT_S, COMMA_S,
  ...
  string per_str, times_str, plus_str, minus_str, and_str, AND_str, or_str,
      OR_str, XOR_str;
  ...
  bool calculateRPN(string str, int command, size_t index, int msecs,
...
public:
   ...
   * interpreted as a unit epxression to convert the result to.
   * @returns true if the calculation was successfully started (and finished if
   * msecs > 0).
   */
  bool calculate(MathStructure *mstruct, string str, int msecs,
   ...
   * ending "to"-commmands, in addition to unit conversion, such "to
   * hexadecimal" or to "fractions", similar to the qalc application.
   *
   *
   * @param str Expression.
   * @param msecs The maximum time for the calculation in milliseconds. If msecs
   ...
   * \since 2.6.0
   */
  string calculateAndPrint(
      string str, int msecs = 10000,
      const EvaluationOptions &eo = default_user_evaluation_options,
   ...
   */
  string print(const MathStructure &mstruct, int milliseconds = 100000,
   ...
   */
  bool
  RPNStackEnter(string str, int msecs,
                const EvaluationOptions &eo = default_user_evaluation_options,
                MathStructure *parsed_struct = NULL,
                MathStructure *to_struct = NULL, bool make_to_division = true);
  ...
  setRPNRegister(size_t index, MathStructure *mstruct, int msecs,
                 const EvaluationOptions &eo = default_user_evaluation_options);
  bool
  setRPNRegister(size_t index, string str, int msecs,
                 const EvaluationOptions &eo = default_user_evaluation_options,
                 MathStructure *parsed_struct = NULL,
                 MathStructure *to_struct = NULL, bool make_to_division = true);
  void
  setRPNRegister(size_t index, MathStructure *mstruct, bool eval = false,
                 const EvaluationOptions &eo = default_user_evaluation_options);
  void
  setRPNRegister(size_t index, string str,
                 const EvaluationOptions &eo = default_user_evaluation_options,
                 MathStructure *parsed_struct = NULL,
                 MathStructure *to_struct = NULL, bool make_to_division = true);
   ...
   */
  string
  unlocalizeExpression(string str,
                       const ParseOptions &po = default_parse_options) const;
   ...
   */
  bool separateToExpression(string &str, string &to_str,
  ...
  void parse(MathStructure *mstruct, string str,
             const ParseOptions &po = default_parse_options);
  bool parseNumber(MathStructure *mstruct, string str,
                   const ParseOptions &po = default_parse_options);
  bool parseOperators(MathStructure *mstruct, string str,
                      const ParseOptions &po = default_parse_options);
  bool parseAdd(string &str, MathStructure *mstruct, const ParseOptions &po,
                MathOperation s, bool append = true);
  bool parseAdd(string &str, MathStructure *mstruct, const ParseOptions &po);
  //@}
   ...
   */
  MathStructure
  convert(const MathStructure &mstruct, string composite_,
          const EvaluationOptions &eo = default_user_evaluation_options,
  ...
  convert(double value, Unit *from_unit, Unit *to_unit,
          const EvaluationOptions &eo = default_user_evaluation_options);
  MathStructure
  convert(string str, Unit *from_unit, Unit *to_unit, int milliseconds,
          const EvaluationOptions &eo = default_user_evaluation_options);
  /** Depecated: use convert() */
  MathStructure
  convertTimeOut(string str, Unit *from_unit, Unit *to_unit, int milliseconds,
                 const EvaluationOptions &eo = default_user_evaluation_options);
  MathStructure
  convert(string str, Unit *from_unit, Unit *to_unit,
          const EvaluationOptions &eo = default_user_evaluation_options);
   ...
   * (centi, deci, deka, hekto) will be skipped.
  ...
  ExpressionItem *getActiveExpressionItem(string name,
                                          ExpressionItem *item = NULL);
  ExpressionItem *getInactiveExpressionItem(string name,
                                            ExpressionItem *item = NULL);
  ...
  bool variableNameIsValid(const char *name_, int version_numbers[3],
                           bool is_user_defs);
  bool variableNameIsValid(const string &name_, int version_numbers[3],
                           bool is_user_defs);
  ...
  bool functionNameIsValid(const char *name_, int version_numbers[3],
                           bool is_user_defs);
  bool functionNameIsValid(const string &name_, int version_numbers[3],
                           bool is_user_defs);
  ...
  bool unitNameIsValid(const char *name_, int version_numbers[3],
                       bool is_user_defs);
  bool unitNameIsValid(const string &name_, int version_numbers[3],
                       bool is_user_defs);
  ...
  string getName(string name = "", ExpressionItem *object = NULL,
  ...
  void
  endTemporaryStopMessages(bool release_messages,
                           vector<CalculatorMessage> *blocked_messages = NULL);
  ...
  bool importCSV(MathStructure &mstruct, const char *file_name,
                 int first_row = 1, string delimiter = ",",
                 vector<string> *headers = NULL);
  bool importCSV(const char *file_name, int first_row = 1, bool headers = true,
                 string delimiter = ",", bool to_matrix = false,
                 string name = "", string title = "", string category = "");
  ...
  MathStructure expressionToPlotVector(
      ...
      int steps, MathStructure *x_vector = NULL, string x_var = "\\x",
      const ParseOptions &po = default_parse_options, int msecs = 5000);
  MathStructure
  expressionToPlotVector(string expression, float min, float max, int steps,
                         MathStructure *x_vector = NULL, string x_var = "\\x",
                         const ParseOptions &po = default_parse_options,
                         int msecs = 5000);
  MathStructure
  expressionToPlotVector(string expression, const MathStructure &min,
                         const MathStructure &max, const MathStructure &step,
                         MathStructure *x_vector = NULL, string x_var = "\\x",
                         const ParseOptions &po = default_parse_options,
                         int msecs = 5000);
  MathStructure
  expressionToPlotVector(string expression, float min, float max, float step,
                         MathStructure *x_vector = NULL, string x_var = "\\x",
                         const ParseOptions &po = default_parse_options,
                         int msecs = 5000);
  MathStructure expressionToPlotVector(
      string expression, const MathStructure &x_vector, string x_var = "\\x",
      const ParseOptions &po = default_parse_options, int msecs = 5000);
  bool plotVectors(PlotParameters *param,
                   const vector<MathStructure> &y_vectors,
                   const vector<MathStructure> &x_vectors,
                   vector<PlotDataParameters *> &pdps, bool persistent = false,
                   int msecs = 5000);
   ...
   * @returns Storage id.
   */
  size_t parseAddId(MathFunction *f, const string &str, const ParseOptions &po,
                    bool persistent = false);
  size_t parseAddIdAppend(MathFunction *f, const MathStructure &append_mstruct,
                          const string &str, const ParseOptions &po,
                          bool persistent = false);
  size_t parseAddVectorId(const string &str, const ParseOptions &po,
                          bool persistent = false);
