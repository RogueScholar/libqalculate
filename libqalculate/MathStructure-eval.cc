            ...
            if(mstruct[i].isFunction() && mstruct[i].function()->id() == FUNCTION_ID_LOG && mstruct[i].size() == 1 && mstruct[i][0].isNumber() && mstruct[i][0].number().isReal()) {
                if(i_ln == (size_t) -1) {
                    ...
                    if(mstruct[i_ln].isMultiplication()) {
                        if(mstruct[i_ln][1][0].number().raise(mstruct[i_ln][0].number(), true)) {
                ...
                if(mstruct[i][0].number().isPositive()) {
                    ...
                    if(i_ln_m == (size_t) -1) {
                        ...
                        if(!b && mstruct[i_ln_m][1][0].number().raise(-mstruct[i_ln_m][0].number())) {
    ...
    if(m_type == STRUCT_NUMBER && o_number.hasImaginaryPart()) {
        ...
        case ANGLE_UNIT_DEGREES: {
            if(CALCULATOR->getDegUnit()) {
                ...
                CHILD(1).calculateDivide(CALCULATOR->getVariableById(VARIABLE_ID_PI), eo2);
