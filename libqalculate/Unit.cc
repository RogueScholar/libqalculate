...
const string &Unit::countries() const {
    return scountries;
}
...
bool Unit::containsRelativeTo(Unit *u) const {
    return false;
}
bool Unit::hasNonlinearRelationToBase() const {
    return false;
}
bool Unit::hasApproximateRelationToBase(bool, bool) const {
    return false;
}
...
int AliasUnit::mixWithBase() const {
    return i_mix;
}
int AliasUnit::mixWithBaseMinimum() const {
    return i_mix_min;
}
void AliasUnit::setMixWithBase(int mix_priority) {
    i_mix = mix_priority;
}
...
bool AliasUnit::hasNonlinearRelationToBase() const {
    return hasNonlinearRelationTo(baseUnit()) || baseUnit()->hasNonlinearRelationToBase();
}
bool AliasUnit::hasApproximateRelationToBase(bool check_variables, bool ignore_high_precision_intervals) const {
    return hasApproximateRelationTo(baseUnit(), check_variables, ignore_high_precision_intervals) || baseUnit()->hasApproximateRelationToBase(check_variables, ignore_high_precision_intervals);
}
