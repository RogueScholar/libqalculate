...
bool Unit::isCurrency() const { return baseUnit() == CALCULATOR->u_euro; }
...
bool Unit::convert(Unit *u, MathStructure &mvalue, MathStructure &mexp) const {
  if (u == this) {
    ...
    if (isCurrency() && u->isCurrency() &&
        ((isBuiltin() && this != CALCULATOR->u_euro) ||
         (u->isBuiltin() && u != CALCULATOR->u_euro))) {
      int i = 1;
      if (u == CALCULATOR->u_btc || this == CALCULATOR->u_btc)
        i = 2;
      if (u->subtype() == SUBTYPE_ALIAS_UNIT) {
        if (i < 2 && ((AliasUnit *)u)->firstBaseUnit() == CALCULATOR->u_btc)
          i = 2;
        else if (((AliasUnit *)u)->firstBaseUnit() != CALCULATOR->u_euro)
          i = 3;
      }
      if (i < 3 && subtype() == SUBTYPE_ALIAS_UNIT) {
        if (i < 2 && ((AliasUnit *)this)->firstBaseUnit() == CALCULATOR->u_btc)
          i = 2;
        else if (((AliasUnit *)this)->firstBaseUnit() != CALCULATOR->u_euro)
          i = 3;
      }
