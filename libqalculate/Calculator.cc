...
Prefix *Calculator::getDecimalNullPrefix() const {
    return decimal_null_prefix;
}
Prefix *Calculator::getBinaryNullPrefix() const {
    return binary_null_prefix;
}
...
void Calculator::addBuiltinUnits() {
    ...
    u_btc = addUnit(new AliasUnit(_("Currency"), "BTC", "bitcoins", "bitcoin", "Bitcoins", u_euro, "8834.66", 1, "", false, true, true));
    u_btc->setApproximate();
    u_btc->setPrecision(-2);
    u_btc->setChanged(false);
    priv->u_byn = addUnit(new AliasUnit(_("Currency"), "BYN", "", "", "Belarusian Ruble", u_euro, "2.4065", 1, "", false, true, true));
