...
void Number::intervalToMidValue() {
    return intervalToMidValue(false);
}
...
void Number::operator = (const Number &o) {
    set(o);
}
void Number::operator = (long int i) {
    set(i, 1);
}
...
bool Number::operator == (long int i) const {
    return equals(i);
}
bool Number::operator != (long int i) const {
    return !equals(i);
...
bool Number::operator <= (long int i) const {
    return isLessThanOrEqualTo(i);
}
bool Number::operator > (long int i) const {
    return isGreaterThan(i);
}
bool Number::operator >= (long int i) const {
    return isGreaterThanOrEqualTo(i);
}
...
bool Number::testErrors(int error_level) const {
    if(mpfr_underflow_p()) {
        if(error_level) CALCULATOR->error(error_level > 1, _("Floating point underflow"), NULL);
        return true;
    }
    if(mpfr_overflow_p()) {
        if(error_level) CALCULATOR->error(error_level > 1, _("Floating point overflow"), NULL);
        return true;
    }
    if(mpfr_divby0_p()) {
        if(error_level) CALCULATOR->error(error_level > 1, _("Floating point division by zero exception"), NULL);
        return true;
    }
    if(mpfr_nanflag_p()) {
        if(error_level) CALCULATOR->error(error_level > 1, _("Floating point not a number exception"), NULL);
        return true;
    }
    if(mpfr_erangeflag_p()) {
        if(error_level) CALCULATOR->error(error_level > 1, _("Floating point range exception"), NULL);
        return true;
    }
    return false;
}
...
bool Number::bernoulli() {
    ...
    case 72: {
        set(Number("-5827954961669944110438277244641067365282488301844260429"), true);
    ...
    case 78: {
        set(Number("414846365575400828295179035549542073492199375372400483487"), true);
        divide(3318);
        return true;
    }
    case 80: {
        set(Number("-4603784299479457646935574969019046849794257872751288919656867"), true);
        divide(230010L);
        return true;
    }
    case 82: {
        set(Number("1677014149185145836823154509786269900207736027570253414881613"), true);
        divide(498);
        return true;
    }
    case 84: {
        set(Number("-2024576195935290360231131160111731009989917391198090877281083932477"), true);
        divide(Number("3404310"));
        return true;
    }
    case 86: {
        set(Number("660714619417678653573847847426261496277830686653388931761996983"), true);
        divide(6);
        return true;
    }
    case 88: {
        set(Number("-1311426488674017507995511424019311843345750275572028644296919890574047"), true);
        divide(61410);
        return true;
    }
    case 90: {
        set(Number("1179057279021082799884123351249215083775254949669647116231545215727922535"), true);
        divide(272118L);
        return true;
    }
    case 92: {
        set(Number("-1295585948207537527989427828538576749659341483719435143023316326829946247"), true);
        divide(1410);
        return true;
    }
    case 94: {
        set(Number("1220813806579744469607301679413201203958508415202696621436215105284649447"), true);
        divide(6);
        return true;
    }
    case 96: {
        set(Number("-211600449597266513097597728109824233673043954389060234150638733420050668349987259"), true);
        divide(Number("4501770"));
        return true;
    }
    case 98: {
        set(Number("67908260672905495624051117546403605607342195728504487509073961249992947058239"), true);
        divide(6);
        return true;
    }
    case 100: {
        set(Number("-94598037819122125295227433069493721872702841533066936133385696204311395415197247711"), true);
        divide(33330);
        return true;
    }
    case 102: {
        set(Number("3204019410860907078243020782116241775491817197152717450679002501086861530836678158791"), true);
        divide(4326);
        return true;
    }
    case 104: {
        set(Number("-319533631363830011287103352796174274671189606078272738327103470162849568365549721224053"), true);
        divide(1590);
        return true;
    }
    case 106: {
        set(Number("36373903172617414408151820151593427169231298640581690038930816378281879873386202346572901"), true);
        divide(642);
        return true;
    }
    case 108: {
        set(Number("-3469342247847828789552088659323852541399766785760491146870005891371501266319724897592306597338057"), true);
        divide(Number("209191710"));
        return true;
    }
    case 110: {
        set(Number("7645992940484742892248134246724347500528752413412307906683593870759797606269585779977930217515"), true);
        divide(1518);
        return true;
    }
    case 112: {
        set(Number("-2650879602155099713352597214685162014443151499192509896451788427680966756514875515366781203552600109"), true);
        divide(Number("1671270"));
        return true;
    }
    case 114: {
        set(Number("2173783231936916333331076108665299147572115667909083136080611011493360548423459 3650904188618562649"), true);
        divide(42);
        return true;
    }
    case 116: {
        set(Number("-309553916571842976912513458033841416869004128064329844245504045721008957524571 968271388199595754752259"), true);
        divide(1770);
        return true;
    }
    case 118: {
        set(Number("3669631199697131115349471515855850066846063610806992043010594406764144850458064 61889371776354517095799"), true);
        divide(6);
        return true;
    }
    case 120: {
        set(Number("-515074865350791090618439968578499832740951703532626752130928691671992974749229 85358811329367077682677803282070131"), true);
        divide(Number("2328255930"));
        return true;
    }
    case 122: {
        set(Number("4963366607926258191253263747599075743872279031106013977030931179315068321410043 1329033113678098037968564431"), true);
        divide(6);
        return true;
    }
    case 124: {
        set(Number("-958767753342471287507749031075424446205788300132973368195535127293585933544359 44413631943610268472689094609001"), true);
        divide(30);
        return true;
    }
    case 126: {
        set(Number("5556330281949274850616324408918951380525567307126747246796782304333594286400508 981287241419934529638692081513802696639"), true);
        divide(Number("4357878"));
        return true;
    }
    case 128: {
        set(Number("-267754707742548082886954405585282394779291459592551740629978686063357792734863 530145362663093519862048495908453718017"), true);
        divide(510);
        return true;
    }
    case 130: {
        set(Number("1928215175136130915645299522271596435307611010164728458783733020528548622403504 078595174411693893882739334735142562418015"), true);
        divide(8646);
        return true;
    }
    }
...
bool Number::lambertW(const Number &k) {
    ...
    if(k.isZero() || k.isMinusOne()) {
        if(ip1 && !k.isOne()) {
            ...
            if(nr <= nr_half || (k.isZero() && nr <= Number(5, 8))) {
                if(k.isZero()) {
                    Number ndiv(z);
                    if(!ndiv.multiply(2) || !ndiv.add(1) || !ndiv.multiply(Number("0.827184")) || !ndiv.add(2) || !v.multiply(Number("7.061302897")) || !v.add(Number("0.1237166")) || !v.multiply(Number("0.35173371")) || !v.divide(ndiv)) {
                        CALCULATOR->endTemporaryEnableIntervalArithmetic();
                        CALCULATOR->setPrecision(prec_bak);
                        return false;
                    }
                    ...
                    Number n1p2z(z);
                    if(!n1p2z.multiply(2) || !n1p2z.add(1) || !i4.multiply(n1p2z) || !i4.add(2) || !i3.multiply(n1p2z)) {
                        CALCULATOR->endTemporaryEnableIntervalArithmetic();
                        CALCULATOR->setPrecision(prec_bak);
                        return false;
                    }
        ...
        if(ip1 && (!k.isMinusOne() || z.imaginaryPartIsPositive())) {
            ...
            if(nr <= 1) {
                ...
                Number p3(p);
                if(!p3.raise(nr_three) || !p3.multiply(Number(k.isZero() ? 11 : -11, 72))) {
                    CALCULATOR->endTemporaryEnableIntervalArithmetic();
                    CALCULATOR->setPrecision(prec_bak);
                    return false;
                }
                v.set(p);
                if((!k.isZero() && !v.negate()) || !v.add(-1) || !v.add(p2) || !v.add(p3)) {
                    CALCULATOR->endTemporaryEnableIntervalArithmetic();
                    CALCULATOR->setPrecision(prec_bak);
                    return false;
                }
    ...
    if(ip1) {
        ...
        if(!k.isZero()) {
            twopiKI.pi();
            if(!twopiKI.multiply(k) || !twopiKI.multiply(2) || !twopiKI.multiply(nr_one_i)) {
                CALCULATOR->endTemporaryEnableIntervalArithmetic();
                CALCULATOR->setPrecision(prec_bak);
                return false;
            }
...
bool Number::expint() {
    ...
    if(hasImaginaryPart()) {
        ...
        if(i_value->isMinusInfinity()) {
            if(includesInfinity(true)) return false;
            i_value->pi();
            i_value->negate();
            setPrecisionAndApproximateFrom(*i_value);
            return true;
...
integer_rerun:
        ...
        if(!is_interval) {
            ...
            mpfr_inits2(mpfr_get_prec(fl_value), vl, vu, f_logl, f_logu, f_base, f_log_base, NULL);
