...
public:
    ...
    */
    ...
    virtual int subtype() const {
        return SUBTYPE_UNKNOWN_VARIABLE;
    }
...
public:
    ...
    ExpressionItem *copy() const {
        return new PrecisionVariable(this);
    }
...
public:
    ...
    ExpressionItem *copy() const {
        return new TomorrowVariable(this);
    }
    virtual bool representsPositive(bool = false) {
        return false;
    }
...
public:
    ...
    ExpressionItem *copy() const {
        return new YesterdayVariable(this);
    }
    virtual bool representsPositive(bool = false) {
        return false;
    }
