...
MathStructure *find_abs_sgn(MathStructure &mstruct,
  ...
  case STRUCT_FUNCTION: {
    if (((mstruct.function() == CALCULATOR->f_abs && mstruct.size() == 1) ||
         (mstruct.function() == CALCULATOR->f_signum && mstruct.size() == 2)) &&
...
bool fix_n_multiple(MathStructure &mstruct, const EvaluationOptions &eo,
  ...
  if (mstruct.isComparison()) {
    if (mstruct.comparisonType() == COMPARISON_EQUALS && x_var.isVariable() &&
        ...
        mstruct[1].contains(CALCULATOR->v_n)) {
          ...
          if (CALCULATOR->endTemporaryStopMessages() == 0) {
            if (mtest.isZero()) {
              ...
              b_ret = true;
                       ...
                       mtest.comparisonType() == COMPARISON_EQUALS &&
                       mtest[0] == CALCULATOR->v_n && mtest[1].isNumber()) {
...
bool MathStructure::isolate_x_sub(const EvaluationOptions &eo,
  ...
  case STRUCT_ADDITION: {
    ...
    if ((ct_comp == COMPARISON_EQUALS || ct_comp == COMPARISON_NOT_EQUALS) &&
          ...
          if (CHILD(0)[i].isMultiplication()) {
            ...
            for (size_t i2 = 0; i2 < CHILD(0)[i].size(); i2++) {
              if (CHILD(0)[i][i2].contains(x_var)) {
                if (!mln2 && CHILD(0)[i][i2].isFunction() &&
                    CHILD(0)[i][i2].function() == CALCULATOR->f_ln &&
                    CHILD(0)[i][i2].size() == 1) {
                  mln2 = &CHILD(0)[i][i2];
                } else {
                  mln2 = NULL;
            ...
            if (mln2) {
              ...
              mvar = &CHILD(0)[i];
                     ...
                     CHILD(0)[i].function() == CALCULATOR->f_ln &&
                     CHILD(0)[i].size() == 1) {
            mln = &CHILD(0)[i];
          } else if (!mvar) {
            mvar = &CHILD(0)[i];
      ...
      if (CHILD(0).containsFunction(CALCULATOR->f_cosh) &&
          CHILD(0).containsFunction(CALCULATOR->f_sinh)) {
        // a*cosh(x) + b*cosh(x)
          ...
          if (CHILD(0)[i].isMultiplication()) {
            ...
            for (size_t i2 = 0; i2 < CHILD(0)[i].size(); i2++) {
              if (CHILD(0)[i][i2].contains(x_var)) {
                if (!b_found && CHILD(0)[i][i2].isFunction() &&
                    (CHILD(0)[i][i2].function() == CALCULATOR->f_cosh ||
                     CHILD(0)[i][i2].function() == CALCULATOR->f_sinh) &&
                    CHILD(0)[i][i2].size() == 1 &&
                    (!marg || marg->equals(CHILD(0)[i][i2][0]))) {
                  if (!marg)
                    marg = &CHILD(0)[i][i2][0];
                  if (CHILD(0)[i][i2].function() == CALCULATOR->f_cosh)
                    m_cosh = &CHILD(0)[i][i2];
                  else
                    m_sinh = &CHILD(0)[i][i2];
                  b_found = true;
            ...
            if (!b_found) {
              ...
              break;
                     ...
                     (CHILD(0)[i].function() == CALCULATOR->f_cosh ||
                      CHILD(0)[i].function() == CALCULATOR->f_sinh) &&
                     CHILD(0)[i].size() == 1 &&
                     (!marg || marg->equals(CHILD(0)[i][0]))) {
            if (!marg)
              marg = &CHILD(0)[i][0];
            if (CHILD(0)[i].function() == CALCULATOR->f_cosh)
              m_cosh = &CHILD(0)[i];
            else
              m_sinh = &CHILD(0)[i];
          } else {
        ...
        if (CHILD(0)[i].isPower()) {
          if (CHILD(0)[i][1].isNumber() && !CHILD(0)[i][1].isInteger() &&
            ...
            break;
                   ...
                   CHILD(0)[i].function() == CALCULATOR->f_root) {
              ...
              if (CHILD(0)[i][i2].isPower()) {
                if (CHILD(0)[i][i2][1].isNumber() &&
                  ...
                  break;
                         ...
                         CHILD(0)[i][i2].function() == CALCULATOR->f_root) {
    ...
    if (!mdiv.isUndefined() && b_multiple_div && mdiv.containsInterval()) {
      ...
      if (ct_comp == COMPARISON_EQUALS || ct_comp == COMPARISON_NOT_EQUALS) {
        ...
        if (!mdiv[0].representsNonZero(true)) {
          ...
          add_nocopy(mtest,
                     not_equals ? OPERATION_LOGICAL_OR : OPERATION_LOGICAL_AND);
          calculatesub(eo2, eo, false);
        }
      } else {
    ...
    for (size_t i = 0; i < CHILD(0).size(); i++) {
      ...
      if (!mbase.isZero() && CHILD(0)[i] == mbase) {
        ...
        if (CHILD(0)[i][0].isFunction() &&
            CHILD(0)[i][0].function() == CALCULATOR->f_root &&
        ...
        for (size_t i2 = 0; i2 < CHILD(0)[i].size(); i2++) {
          if (!mbase.isZero() && CHILD(0)[i][i2] == mbase) {
            ...
            if (CHILD(0)[i][i2][0].isFunction() &&
                CHILD(0)[i][i2][0].function() == CALCULATOR->f_root &&
    ...
    if (ct_comp == COMPARISON_EQUALS || ct_comp == COMPARISON_NOT_EQUALS) {
      ...
      if (m && m->function() == CALCULATOR->f_abs) {
        ...
        mcheck->add(m_zero,
                    cmp_type == COMPARISON_NOT_EQUALS
                        ? ((*m)[1].isMinusOne() ? OPERATION_GREATER
                                                : OPERATION_EQUALS_GREATER)
                        : ((*m)[1].isMinusOne() ? OPERATION_EQUALS_LESS
                                                : OPERATION_LESS));
        mcheck->isolate_x_sub(eo, eo2, x_var);
        malt->isolate_x_sub(eo, eo2, x_var);
        malt->add_nocopy(mcheck,
        ...
        CHILD_UPDATED(0)
        mcheck->add(m_zero, cmp_type == COMPARISON_NOT_EQUALS
                                ? ((*m)[1].isOne() ? OPERATION_LESS
                                                   : OPERATION_EQUALS_LESS)
                                : ((*m)[1].isOne() ? OPERATION_EQUALS_GREATER
                                                   : OPERATION_GREATER));
        mcheck->isolate_x_sub(eo, eo2, x_var);
        isolate_x_sub(eo, eo2, x_var);
        add_nocopy(mcheck,
    ...
    if (!b &&
      ...
      if (CHILD(0).size() == 2) {
        ...
        if (CHILD(0)[0].isFunction() &&
            CHILD(0)[0].function() == CALCULATOR->f_ln &&
            CHILD(0)[0].size() == 1) {
          CHILD(0).swapChildren(1, 2);
          b_swap = true;
        }
        if (CHILD(0)[1].isFunction() &&
            CHILD(0)[1].function() == CALCULATOR->f_ln &&
            CHILD(0)[1].size() == 1) {
          ...
          if (nrexp.isZero())
            ...
            nrexp.lcm(CHILD(0)[i][1].number());
                   ...
                   !(CHILD(0)[i].isFunction() &&
                     CHILD(0)[i].function() == CALCULATOR->f_abs &&
                     CHILD(0)[i].size() == 1 &&
    ...
    if (ct_comp == COMPARISON_EQUALS || ct_comp == COMPARISON_NOT_EQUALS) {
      ...
      if (m && m->function() == CALCULATOR->f_abs) {
        ...
        if (!(*m)[1].isOne() && !(*m)[1].isMinusOne()) {
          ...
          (*malt0)[0].calculatesub(eo2, eo, true);
          mcheck = new MathStructure(mabs[0]);
          mcheck->add((*m)[1], cmp_type == COMPARISON_NOT_EQUALS
                                   ? OPERATION_NOT_EQUALS
                                   : OPERATION_EQUALS);
          mcheck->isolate_x_sub(eo, eo2, x_var);
          malt0->isolate_x_sub(eo, eo2, x_var);
  ...
  case STRUCT_POWER: {
    if (CHILD(0)[0].contains(x_var)) {
      if (CHILD(0)[1].contains(x_var)) {
        if ((ct_comp == COMPARISON_EQUALS ||
          ...
          if (!mvar || !get_multiplier(CHILD(0)[1], *mvar, mmul) ||
              mmul.contains(x_var) || !mmul.representsNonZero())
            return false;
          MathStructure mexp(1, 1, 0);
          if (mvar->isPower() && *mvar != CHILD(0)[0])
            mexp = (*mvar)[1];
          if (!mexp.representsPositive())
            return false;
          ...
          MathStructure *marg =
              new MathStructure(CALCULATOR->f_ln, &CHILD(1), NULL);
          if (marg->calculateFunctions(eo))
            marg->calculatesub(eo2, eo, true);
          if (CHILD(1).representsPositive() &&
              CHILD(0)[0].representsNonComplex()) {
            if (!mexp.isOne())
              marg->calculateMultiply(mexp, eo2);
            if (!mmul.isOne())
            ...
            marg2->swapChildren(1, 2);
            marg2->isolate_x_sub(eo, eo2, x_var, morig);
            marg2->add_nocopy(mreq1, ct_comp == COMPARISON_NOT_EQUALS
                                         ? OPERATION_LOGICAL_OR
                                         : OPERATION_LOGICAL_AND);
            marg2->calculatesub(eo2, eo, false);
            ...
            marg3->swapChildren(1, 2);
            marg3->isolate_x_sub(eo, eo2, x_var, morig);
            marg3->add_nocopy(mreq2, ct_comp == COMPARISON_NOT_EQUALS
                                         ? OPERATION_LOGICAL_OR
                                         : OPERATION_LOGICAL_AND);
        ...
        if (CHILD(0)[1].number().isMinusOne()) {
            ...
            if (CHILD(1).representsNegative(true)) {
              ...
              if (CHILD(1).isNumber() && !CHILD(1).number().hasRealPart()) {
                ...
                case ANGLE_UNIT_DEGREES: {
                  marg.multiply(Number(1, 180, 0));
                  marg.multiply(CALCULATOR->v_pi);
                  break;
                }
                case ANGLE_UNIT_GRADIANS: {
                  marg.multiply(Number(1, 200, 0));
                  marg.multiply(CALCULATOR->v_pi);
                  break;
                }
          ...
          if (warn_complex)
            CALCULATOR->error(
                false,
                _("Only one or two of the roots where calculated for %s."),
                format_and_print(mbak).c_str(), NULL);
        } else {
      ...
      if (CHILD(0)[1].representsNonComplex()) {
        ...
        CHILD(1).divide_nocopy(
            new MathStructure(CALCULATOR->f_ln, &CHILD(0)[0], NULL));
  ...
  case STRUCT_FUNCTION: {
    if (CHILD(0).function() == CALCULATOR->f_root && VALID_ROOT(CHILD(0))) {
    ...
    } else if (CHILD(0).function() == CALCULATOR->f_ln &&
               CHILD(0).size() == 1) {
      if (CHILD(0)[0].contains(x_var)) {
    ...
    } else if (CHILD(0).function() == CALCULATOR->f_lambert_w &&
               (CHILD(0).size() == 1 ||
                (CHILD(0).size() == 2 && CHILD(0)[1].isZero())) &&
               (ct_comp == COMPARISON_EQUALS ||
                ct_comp == COMPARISON_NOT_EQUALS)) {
      if (CHILD(0)[0].contains(x_var)) {
        MathStructure msave(CHILD(1));
    ...
    } else if (CHILD(0).function() == CALCULATOR->f_logn &&
               CHILD(0).size() == 2) {
      if (CHILD(0)[0].contains(x_var)) {
        MathStructure msave(CHILD(1));
        CHILD(1) = CHILD(0)[1];
      ...
      if (f == CALCULATOR->f_sin)
        CHILD(1).transform(CALCULATOR->f_asin);
      else if (f == CALCULATOR->f_cos)
        CHILD(1).transform(CALCULATOR->f_acos);
      else
        CHILD(1).transform(CALCULATOR->f_atan);
      ...
      if (f == CALCULATOR->f_sin || f == CALCULATOR->f_cos) {
        ...
        if (f == CALCULATOR->f_sin) {
          switch (eo.parse_options.angle_unit) {
          case ANGLE_UNIT_DEGREES: {
            (*malt)[1].add(Number(180, 1), true);
            break;
          }
          case ANGLE_UNIT_GRADIANS: {
            (*malt)[1].add(Number(200, 1), true);
            break;
          }
          case ANGLE_UNIT_RADIANS: {
            (*malt)[1].add(CALCULATOR->v_pi, true);
            break;
          }
          default: {
            (*malt)[1].add(CALCULATOR->v_pi, true);
            (*malt)[1].last() *= CALCULATOR->getRadUnit();
          }
          }
        }
        CHILD(1).calculatesub(eo2, eo, true);
      ...
      if (CHILD(0).representsNonComplex()) {
        ...
        CHILD(1).last() *= nr_two;
        (*malt)[1] += CALCULATOR->v_n;
        (*malt)[1].last() *= CALCULATOR->v_pi;
        (*malt)[1].last() *= nr_two;
        CHILD(1) *= nr_one_i;
        (*malt)[1] *= nr_one_i;
        CHILD(1).calculatesub(eo2, eo, true);
      ...
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_asin &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      ...
      switch (eo.parse_options.angle_unit) {
      case ANGLE_UNIT_DEGREES: {
        CHILD(1) *= CALCULATOR->getDegUnit();
        break;
      }
      case ANGLE_UNIT_GRADIANS: {
        CHILD(1) *= CALCULATOR->getGraUnit();
        break;
      }
      case ANGLE_UNIT_RADIANS: {
        CHILD(1) *= CALCULATOR->getRadUnit();
        break;
      }
      default: {
      }
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_acos &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      ...
      mreq2->transform(ct_comp == COMPARISON_NOT_EQUALS
                           ...
                           : COMPARISON_EQUALS_GREATER,
                       m_zero);
      mreq3->transform(ct_comp == COMPARISON_NOT_EQUALS ? COMPARISON_EQUALS
                                                        : COMPARISON_NOT_EQUALS,
                       m_zero);
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_atan &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      MathStructure m1(CHILD(1));
      CHILD(0).setToChild(1, true);
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_asinh &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      MathStructure m1(CHILD(1));
      CHILD(0).setToChild(1, true);
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_acosh &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      MathStructure m1(CHILD(1));
      CHILD(0).setToChild(1, true);
      ...
      if (m1.calculateFunctions(eo))
        m1.calculatesub(eo2, eo, true);
      if (m1im.calculateFunctions(eo))
        m1im.calculatesub(eo2, eo, true);
      MathStructure *mreq1 = new MathStructure(m1);
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_atanh &&
               (ct_comp == COMPARISON_NOT_EQUALS ||
                ct_comp == COMPARISON_EQUALS)) {
      MathStructure m1(CHILD(1));
      CHILD(0).setToChild(1, true);
      ...
      calculatesub(eo2, eo, false);
      return true;
    } else if (CHILD(0).function() == CALCULATOR->f_abs &&
               CHILD(0).size() == 1) {
      if (CHILD(0)[0].contains(x_var)) {
    ...
    } else if (CHILD(0).function() == CALCULATOR->f_signum &&
               CHILD(0).size() == 2) {
      if (CHILD(0)[0].contains(x_var) &&
...
bool sync_sine(MathStructure &mstruct, const EvaluationOptions &eo,
  ...
  if (!mstruct_parent.isUndefined() && mstruct.isFunction() &&
      mstruct.function() == (b_hyp ? CALCULATOR->f_sinh : CALCULATOR->f_sin) &&
...
bool simplify_functions(MathStructure &mstruct, const EvaluationOptions &eo,
  ...
  if (mstruct.containsFunction(CALCULATOR->f_sin, false, false, false) > 0 &&
      mstruct.containsFunction(CALCULATOR->f_cos, false, false, false)) {
    if (x_var.isUndefined()) {
      // a*(sin(x)+cos(x))=a*sqrt(2)*sin(x+pi/4)
      bool b_ret = false;
      for (size_t i = 0; i < mstruct.size(); i++) {
        if (mstruct[i].isFunction() && mstruct[i].size() == 1 &&
            mstruct[i].function() == CALCULATOR->f_sin) {
          for (size_t i2 = 0; i2 < mstruct.size(); i2++) {
            if (i != i2 && mstruct[i2].isFunction() &&
                mstruct[i2].size() == 1 &&
                mstruct[i2].function() == CALCULATOR->f_cos &&
          ...
          for (size_t i3 = 0; i3 < mstruct[i].size(); i3++) {
            if (mstruct[i][i3].isFunction() && mstruct[i][i3].size() == 1 &&
                mstruct[i][i3].function() == CALCULATOR->f_sin) {
      ...
      for (size_t i = 0; i < mstruct.size(); i++) {
        if (mstruct[i].isFunction() && mstruct[i].size() == 1 &&
            (mstruct[i].function() == CALCULATOR->f_sin ||
             mstruct[i].function() == CALCULATOR->f_cos) &&
          ...
          for (size_t i2 = 0; i2 < mstruct[i].size(); i2++) {
            if (!marg && mstruct[i][i2].isFunction() &&
                mstruct[i][i2].size() == 1 &&
                (mstruct[i][i2].function() == CALCULATOR->f_sin ||
                 mstruct[i][i2].function() == CALCULATOR->f_cos) &&
        ...
        if (marg) {
          ...
          for (size_t i3 = i + 1; i3 < mstruct.size(); i3++) {
            if (mstruct[i3].isFunction() && mstruct[i3].size() == 1 &&
                mstruct[i3].function() ==
                    (b_cos ? CALCULATOR->f_sin : CALCULATOR->f_cos) &&
                mstruct[i3][0] == *marg) {
              b = true;
              ...
              for (size_t i2 = 0; i2 < mstruct[i3].size(); i2++) {
                if (!b2 && mstruct[i3][i2].isFunction() &&
                    ...
                    (mstruct[i3][i2].function() == CALCULATOR->f_sin ||
                     mstruct[i3][i2].function() == CALCULATOR->f_cos) &&
                    mstruct[i3][i2][0] == *marg) {
                  if ((mstruct[i3][i2].function() == CALCULATOR->f_sin) ==
                      b_cos)
                    b = true;
                  b2 = true;
        ...
        if (marg) {
          ...
          for (size_t i3 = i; i3 < mstruct.size();) {
            bool b = false;
            if (mstruct[i3].isFunction() && mstruct[i3].size() == 1 &&
                mstruct[i3].function() == CALCULATOR->f_sin &&
                mstruct[i3][0] == *marg) {
              if (m_a.isZero())
                m_a = m_one;
              else
              ...
              b = true;
                       ...
                       mstruct[i3].function() == CALCULATOR->f_cos &&
                       mstruct[i3][0] == *marg) {
              if (m_b.isZero())
                m_a = m_one;
              else
          ...
          MathStructure *m_atan =
              new MathStructure(CALCULATOR->f_atan, &m_b, NULL);
